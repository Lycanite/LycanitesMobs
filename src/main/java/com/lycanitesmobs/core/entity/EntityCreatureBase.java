...
public abstract class EntityCreatureBase extends EntityLiving {
    ...
    **/
	...
	protected void setSize(float width, float height) {
        ...
        this.hitAreas = null;
        if(!this.worldObj.isRemote && this.getNavigator() != null && this.getNavigator().getNodeProcessor() != null && this.getNavigator().getNodeProcessor() instanceof ICreatureNodeProcessor)
