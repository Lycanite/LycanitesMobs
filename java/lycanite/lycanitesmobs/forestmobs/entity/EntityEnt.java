...
public class EntityEnt extends EntityCreatureAgeable implements IMob {
    ...
    public EntityEnt(World par1World) {
        ...
        this.targetTasks.addTask(0, new EntityAITargetRevenge(this).setHelpClasses(EntityTrent.class));
