...
public class BlockShadowfire extends BlockBase {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
    	AssetManager.addSpriteGroup(blockName, this.group, new String[]{"shadowfire_layer_0", "shadowfire_layer_1"}, iconRegister);
    }
    ...
    public IIcon getIcon(int par1, int par2) {
        return AssetManager.getSpriteGroup(blockName)[0];
    }
