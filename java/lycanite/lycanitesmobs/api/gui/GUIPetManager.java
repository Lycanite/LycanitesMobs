...
public class GUIPetManager extends GuiScreen {
	...
	protected void drawGuiContainerForegroundLayer(int x, int y, float f) {
		this.getFontRenderer().drawString(StatCollector.translateToLocal("gui.petmanager.name"), this.centerX - 24, this.windowY + 6, 0xFFFFFF);
	}
