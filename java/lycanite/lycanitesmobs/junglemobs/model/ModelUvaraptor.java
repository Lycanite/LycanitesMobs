...
public class ModelUvaraptor extends ModelCustomObj {
    ...
    public ModelUvaraptor(float shadowSize) {
    	...
    	setPartCenter("head", 0F, 1.2F, 1.0F);
    	setPartCenter("mouth", 0F, 1.0F, 1.4F);
    	setPartCenter("body", 0F, 1.2F, 1.0F);
    	setPartCenter("leftarm", 0.3F, 0.9F, 0.5F);
    	setPartCenter("rightarm", -0.3F, 0.9F, 0.5F);
