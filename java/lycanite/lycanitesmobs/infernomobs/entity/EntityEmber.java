...
public class EntityEmber extends EntityThrowable implements ICustomProjectile {
	public String entityName = "Ember";
	public ILycaniteMod mod = InfernoMobs.instance;
	
	// Properties:
	public Entity shootingEntity;
	byte damage = 2;
	private float projectileScale = 2.0f;
