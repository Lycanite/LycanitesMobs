...
import lycanite.lycanitesmobs.core.entity.ai.EntityAIMoveRestriction;
...
import lycanite.lycanitesmobs.core.entity.ai.DirectNavigator;
import lycanite.lycanitesmobs.core.entity.navigate.*;
import lycanite.lycanitesmobs.core.info.*;
import lycanite.lycanitesmobs.core.inventory.ContainerCreature;
import lycanite.lycanitesmobs.core.inventory.InventoryCreature;
...
public abstract class EntityCreatureBase extends EntityLiving {
    ...
    **/
    ...
    public void onLivingUpdate() {
        ...
        // Boss Health Bar:
        if(!this.getEntityWorld().isRemote && this.showBossInfo()) {
            if(this.bossInfo == null) {
                if(this.boss)
