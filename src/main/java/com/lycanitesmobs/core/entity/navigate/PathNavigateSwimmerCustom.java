...
public class PathNavigateSwimmerCustom extends net.minecraft.pathfinding.PathNavigateSwimmer {
    ...
    protected boolean isDirectPathBetweenPoints(Vec3d posVec31, Vec3d posVec32, int sizeX, int sizeY, int sizeZ) {
        RayTraceResult raytraceresult = this.worldObj.rayTraceBlocks(posVec31, new Vec3d(posVec32.xCoord, this.theEntity.getEntityBoundingBox().minY + 0.5D, posVec32.zCoord), false, true, false);
