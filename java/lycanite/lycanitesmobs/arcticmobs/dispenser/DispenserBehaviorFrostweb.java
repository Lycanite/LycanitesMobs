...
public class DispenserBehaviorFrostweb extends BehaviorProjectileDispense {
    ...
    protected void playDispenseSound(IBlockSource par1IBlockSource) {
        par1IBlockSource.getWorld().playSoundEffect(par1IBlockSource.getX(), par1IBlockSource.getY(), par1IBlockSource.getZ(), AssetManager.getSound("Frostweb"), 1.0F, 1.0F / (new Random().nextFloat() * 0.4F + 0.8F));
    }
}