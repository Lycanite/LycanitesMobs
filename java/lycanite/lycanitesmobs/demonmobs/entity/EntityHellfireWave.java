...
public class EntityHellfireWave extends EntityProjectileBase {
    ...
    public ResourceLocation getTexture() {
        if(AssetManager.getTexture("hellfirewave") == null)
            AssetManager.addTexture("hellfirewave", this.group, "textures/items/hellfirewave" + ".png");
        return AssetManager.getTexture("hellfirewave");
    }
}
