...
public class SwimNodeProcessorCustom extends SwimNodeProcessor {
    ...
    public PathPoint getStart() {
        PathPoint pp = this.openPoint(MathHelper.floor_double(this.entity.posX), MathHelper.floor_double(this.entity.posY), MathHelper.floor_double(this.entity.posZ));
        return pp;
    }

    @Override
    public PathPoint getPathPointToCoords(double x, double y, double z) {
        PathPoint pp = this.openPoint(MathHelper.floor_double(x - (double)(this.entity.width / 2.0F)), MathHelper.floor_double(y), MathHelper.floor_double(z - (double)(this.entity.width / 2.0F)));
        return pp;
    }
