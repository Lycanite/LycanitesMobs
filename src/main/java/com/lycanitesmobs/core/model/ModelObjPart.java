...
public class ModelObjPart {
    ...
    public String name;
    /** The parent name of this model part, null if this part has no parent. This will do all animations that the parent does. **/
    ...
    public void addAnimationFrame(ModelObjAnimationFrame frame) {
        ...
        for(ModelObjPart part : this.children.values()) {
            if(part == null)
                continue;
            part.addAnimationFrame(frame);
        }
    }
}
