...
public class EntityPortal extends EntityProjectileBase {
    ...
    public void moveToTarget() {
    	if(this.shootingEntity != null && this.summoningPedestal == null) {
			...
			RayTraceResult target = Utilities.raytrace(this.worldObj, this.shootingEntity.posX, this.shootingEntity.posY, this.shootingEntity.posZ, this.targetX, this.targetY, this.targetZ, 1.0F, null);
